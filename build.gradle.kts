...
val versionObject = Version(breaking = "1", minor = "1", nonbreaking = "0", revision = "1", date = "2206")
...
tasks.jar {
    ...
    manifest.attributes(
        mapOf(
            ...
            "Automatic-Module-Name" to "com.riskrieg.palette"
        )
    )
...
fun generatePom(pom: MavenPom) {
    ...
    pom.description.set("Standard Java representation of Riskrieg palettes and the RKP file format: https://riskrieg.com")
    pom.url.set("https://github.com/Riskrieg/palette")
    pom.scm {
        url.set("https://github.com/Riskrieg/palette")
        connection.set("scm:git:git://github.com/Riskrieg/palette.git")
        developerConnection.set("scm:git:ssh:git@github.com:Riskrieg/palette.git")
    }
    pom.licenses {
        license {
            name.set("MIT License")
            url.set("https://github.com/Riskrieg/palette/blob/main/LICENSE")
